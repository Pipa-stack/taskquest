...
export const CHARACTERS = [
  { id: 'warrior', emoji: '⚔️', name: 'Guerrero',  cost: 100,  stage: 'I'   },
  { id: 'mage',    emoji: '🧙', name: 'Mago',      cost: 200,  stage: 'I'   },
  { id: 'ranger',  emoji: '🏹', name: 'Arquero',   cost: 150,  stage: 'I'   },
  { id: 'healer',  emoji: '💊', name: 'Curandero', cost: 300,  stage: 'I'   },
  { id: 'rogue',   emoji: '🗡️', name: 'Pícaro',    cost: 250,  stage: 'I'   },
  { id: 'paladin', emoji: '🛡️', name: 'Paladín',   cost: 400,  stage: 'I'   },
]
